...
//                .secure(true) TODO : TLS 적용 후에 주석 제거
    ...
    private String requestGoogleAccessToken(String code) {
        try {
            String clientId = commonVO.googleClientId; // 클라이언트 ID
            String clientSecret = commonVO.googleClientSecret; // 클라이언트 보안 패스워드
            String tokenUri = commonVO.googleOauth2TokenUri;
            ...
            params.add("redirect_uri", commonVO.googleRedirectUri);
    ...
    private JsonNode getUserResource(String accessToken) {
        try {
            String resourceUri = commonVO.googleOauth2UserinfoUri;
    ...
    public void removeAccessToken(String accessToken) {
        try {
            String tokenUri = UriComponentsBuilder.fromUriString(commonVO.googleOauth2RevokeUri)
